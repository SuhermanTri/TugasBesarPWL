          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="assets/img/paktri.jpg"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Tri Suherman</span>
              </a>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Tender</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./kategori-tender" class="nav-link">
                  <i class="nav-icon bi bi-grip-horizontal"></i>
                  <p>Kategori Tender</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="./docs/layout.html" class="nav-link">
                  <i class="nav-icon bi bi-grip-horizontal"></i>
                  <p>Pengajuan Tender</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./docs/layout.html" class="nav-link">
                  <i class="nav-icon bi bi-grip-horizontal"></i>
                  <p>Sertifikasi Tender</p>
                </a>
              </li>
            </ul>
            <!--end::Sidebar Menu-->
          ...
          <div class="container-fluid">
            ...
            <?php endif ?>
              ...
              <div class="card-footer clearfix">
                <div class="btn btn-primary">Tambah Tender</div>
              </div>
            </div>
